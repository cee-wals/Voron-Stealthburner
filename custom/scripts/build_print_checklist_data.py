#!/usr/bin/env python3
"""
    Tools for building Voron Stealthburner 3D Printed part checklist.
"""
import csv
import os
import re
...
def build_part_list(fpath: str = "/Users/cwilder/Documents/3D Printing/cee-wals/voron-stealthburner/STLs"):
    """
    Usage:
...
def create_csv_file(data, fname:str = '/Users/cwilder/Documents/3D Printing/cee-wals/voron-stealthburner/custom/scripts/voron_stealthburner_part_checklist_data.csv'):
    """
    usage:
        data = build_part_list("/Users/cwilder/Documents/3D Printing/cee-wals/voron-stealthburner/STLs")
        create_csv_file(data, '/Users/cwilder/Documents/3D Printing/cee-wals/voron-stealthburner/custom/scripts/voron_stealthburner_part_checklist_data.csv')
    """
